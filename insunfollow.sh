...
echo ""
echo -e "\e[1;91m [+] Telegram: \e[1;92mb4f2f"
echo -e "\e[1;91m [+] Instagram: \e[1;92mb4f2f\e[1;97m"
echo ""
...
if [[ $user == "" ]]; then
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Giriş\e[0m\n"
read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kullanıcı Adı: \e[0m' user
fi

if [[ -e cookie.$user ]]; then

printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Kullanıcı için bulunan çerezler\e[0m\e[1;77m %s\e[0m\n" $user

default_use_cookie="Y"

read -p $'\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kullan?\e[0m\e[1;77m [Y/n]\e[0m ' use_cookie

use_cookie="${use_cookie:-${default_use_cookie}}"

if [[ $use_cookie == *'Y'* || $use_cookie == *'y'* ]]; then
printf "\e[1;31m[\e[0m\e[1;77m*\e[0m\e[1;31m]\e[0m\e[1;93m Kaydedilmiş kimlik bilgilerini kullanma\e[0m\n"
else
rm -rf cookie.$user
login_user
fi
...
printf "\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m] olarak giriş yapmaya çalışıyorum\e[0m\e[1;93m %s\e[0m\n" $user
IFS=$'\n'
...
grep -o 'kullanıcı adı": "[^ ]*.' $user_account.following.* | cut -d " " -f2 | tr -d '"' | tr -d ',' | sort > $user_account.following_temp
...
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Toplam takip:\e[0m\e[1;77m %s\e[0m\n" $tot_following
printf "\e[1;31m[\e[0m\e[1;77m+\e[0m\e[1;31m]\e[0m\e[1;93m Kayt edildi:\e[0m\e[1;77m %s.following_backup\e[0m\n" $user_account
...
printf "\n"
printf " \e[1;31m[\e[0m\e[1;77m01\e[0m\e[1;31m]\e[0m\e[1;93m Instagram'da Tüm Takipten Çık\e[0m\n"
